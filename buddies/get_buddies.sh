...
JSON="$(jq -n --compact-output --arg PT_MY_API_KEY "$PT_MY_API_KEY" --arg PT_MY_POOL_ID "$PT_MY_POOL_ID" --arg PT_MY_NODE_ID "$PT_MY_NODE_ID" '{apiKey: $PT_MY_API_KEY, nodeId: $PT_MY_NODE_ID, poolId: $PT_MY_POOL_ID}')"
